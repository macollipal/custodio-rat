        ...
        <form onSubmit={handleSubmit} className="bg-white rounded-2xl shadow-sm p-8 space-y-6">
          ...
          {step === 2 && (
            <>
              ...
              <div>
                <label className="block text-sm font-semibold mb-1" style={{ color: '#374151' }}>Empresa *</label>
                {loading ? (
              ...
              <div>
                <label className="block text-sm font-semibold mb-1" style={{ color: '#374151' }}>Tu nombre completo *</label>
                <input
                  type="text"
              ...
              <div>
                <label className="block text-sm font-semibold mb-1" style={{ color: '#374151' }}>Tu RUT (opcional)</label>
                <input
                  type="text"
              ...
              <div>
                <label className="block text-sm font-semibold mb-1" style={{ color: '#374151' }}>Tu email *</label>
                <input
                  type="email"
