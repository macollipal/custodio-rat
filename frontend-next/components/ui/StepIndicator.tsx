...
export default function StepIndicator({ steps, current, className }: StepIndicatorProps) {
  ...
  return (
    <div className={className ?? "mb-6 sticky top-0 z-20 sm:static bg-white/95 sm:bg-transparent backdrop-blur-sm sm:backdrop-blur-0 -mx-4 px-4 sm:mx-0 sm:px-0 py-2 sm:py-0 border-b border-gray-100 sm:border-0"}>
