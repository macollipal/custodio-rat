...
_RAT_TEMPLATES = {
    "IDENTIFICADOR": {
        ...
        "base_legal": "Consentimiento (Art. 12 Ley 21.719)",
    ...
    "UBICACION_PRECISA": {
        ...
        "base_legal": "Consentimiento explícito (Art. 12 Ley 21.719)",
    ...
    "FINANCIERO": {
        ...
        "base_legal": "Ejecución de contrato (Art. 12 Ley 21.719)",
    ...
    "SENSIBLE_SALUD": {
        ...
        "base_legal": "Consentimiento explícito (Art. 16 Ley 21.719 — datos sensibles)",
    ...
    "DEMOGRAFICO": {
        ...
        "base_legal": "Interés legítimo (Art. 12 Ley 21.719)",
