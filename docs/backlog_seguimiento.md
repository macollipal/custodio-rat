# Backlog de Mejoras — Custodio RAT

**Fecha de consultoría**: 2026-06-23
...
## Formulario Admin ARCO (Nueva Solicitud)

| # | Mejora | Impacto Legal | Impacto Comercial | Complejidad | Esfuerzo | Estado | Asignado |
|---|--------|---------------|-------------------|-------------|----------|--------|----------|
| QW1 | Validar + formatear RUT en vivo | MEDIO | ALTO | BAJA | 0.5 día | ✅ Completado | — |
| QW2 | Confirmación de email (doble input) | MEDIO | ALTO | BAJA | 0.5 día | ✅ Completado | — |
| QW3 | Dropdown Tipo con descripciones e iconos | BAJO | MEDIO | BAJA | 1 día | ✅ Completado | — |
| QW4 | Helper text en Prioridad | BAJO | MEDIO | BAJA | 0.5 día | ✅ Completado | — |
| QW5 | Artículos Ley 21.719 visibles por tipo | ALTO | MEDIO | BAJA | 0.5 día | ✅ Completado | — |
| QW6 | Detección de titular duplicado | MEDIO | ALTO | BAJA | 1 día | ✅ Completado | — |
| QW7 | Selector de RAT en el form | ALTO | ALTO | BAJA | 1 día | ✅ Completado | — |
| QW8 | Campos de representante legal | CRÍTICO | ALTO | BAJA | 1 día | ✅ Completado | — |
| QW9 | Date picker para fecha retroactiva | ALTO | MEDIO | BAJA | 1 día | ✅ Completado | — |
| QW10 | WCAG básico (aria-label, aria-required) | MEDIO | MEDIO | BAJA | 1 día | ✅ Completado | — |
...
| Total mejoras | 40 |
| Quick Wins | 40 |
| Mediano plazo | 0 (pendiente) |
| Estratégicas | 0 (pendiente) |
| Esfuerzo total estimado | ~60 días |
