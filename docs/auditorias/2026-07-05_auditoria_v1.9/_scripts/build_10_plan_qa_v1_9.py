"""
Build 10 — Plan de QA v1.9 (Post Iter 11 + Iter 12)
Genera: docs/documentacion_oficial/10_Plan_QA_Custodio_RAT_Manager_v1.9.docx
Cambios v1.9:
...
OUT_FILE = os.path.join(OUT_DIR, "10_Plan_QA_Custodio_RAT_Manager_v1.9.docx")
...
def build():
    ...
    add_cover(doc, title="PLAN DE QUALITY ASSURANCE",
              subtitle="Estrategia, casos de prueba y métricas · v1.9",
              code=DOC_CODE)
    ...
    add_paragraph(doc, "_v1.9 (05-Jul-2026): 9 fixes CRITICOS+ALTOS Iter 12. Score: 6.3/10. pytest: 10/10 PASS (test_rat_tier1_tier2.py). TypeScript: 0 errores._")
    add_paragraph(doc, "QA backend: https://custodio-api-qa.vercel.app. QA frontend: https://custodio-qa.vercel.app.")

    doc.add_heading("2. Casos de prueba nuevos (v1.9 — Iter 11+12)", level=1)
    tc_nuevos = [
