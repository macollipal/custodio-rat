"""
Build 03 — Historias de Usuario v1.9 (Post Iter 11 + Iter 12 audit-loop)
Genera: docs/documentacion_oficial/03_Historias_Usuario_Custodio_RAT_Manager_v1.9.docx
Cambios v1.9:
...
OUT_FILE = os.path.join(OUT_DIR, "03_Historias_Usuario_Custodio_RAT_Manager_v1.9.docx")
...
def build():
    ...
    doc.add_heading("3.19 Fixes v1.9: IDOR multi-tenant, encoding, homologación y PDF (Julio 2026)", level=2)
    hus_v19 = [
