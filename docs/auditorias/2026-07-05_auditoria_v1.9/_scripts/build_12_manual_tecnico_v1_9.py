"""
Build 12 — Manual Técnico v1.9 (Post Iter 11 + Iter 12)
Genera: docs/documentacion_oficial/12_Manual_Tecnico_Custodio_RAT_Manager_v1.9.docx
Cambios v1.9:
...
OUT_FILE = os.path.join(OUT_DIR, "12_Manual_Tecnico_Custodio_RAT_Manager_v1.9.docx")
...
def build():
    ...
    doc.add_heading("1. Cambios técnicos en v1.9", level=1)
    cambios_v18 = [
