"""
Build 09 — Backlog de Producto v1.6.5 (Post Iter 11 + Iter 12)
Genera: docs/documentacion_oficial/09_Backlog_Producto_Custodio_RAT_Manager_v1.6.5.docx
Cambios v1.6.5:
...
OUT_FILE = os.path.join(OUT_DIR, "09_Backlog_Producto_Custodio_RAT_Manager_v1.6.5.docx")
...
def build():
    ...
    doc.add_heading("2. Items cerrados en v1.6.5 (Iter 11 + Iter 12)", level=1)
    items_cerrados = [
