"""
Build 04 — Casos de Uso v1.6.5 (Post Iter 11 + Iter 12)
Genera: docs/documentacion_oficial/04_Casos_de_Uso_Custodio_RAT_Manager_v1.6.5.docx
Cambios v1.6.5:
...
OUT_FILE = os.path.join(OUT_DIR, "04_Casos_de_Uso_Custodio_RAT_Manager_v1.6.5.docx")
...
def build():
    ...
    doc.add_heading("2. Listado de casos de uso nuevos (v1.6.5)", level=1)
    casos_nuevos = [
