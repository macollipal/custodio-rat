"""
Build 06 — Arquitectura de Software v1.6.5 (Post Iter 11 + Iter 12)
Genera: docs/documentacion_oficial/06_Arquitectura_Software_Custodio_RAT_Manager_v1.6.5.docx
Cambios v1.6.5:
...
OUT_FILE = os.path.join(OUT_DIR, "06_Arquitectura_Software_Custodio_RAT_Manager_v1.6.5.docx")
...
def build():
    ...
    add_paragraph(doc, "_En v1.6.5 se implementó: BYTEA 10MB limit (DoS protection), "
    ...
    doc.add_heading("2. Decisiones de Arquitectura (ADRs) — Novedades v1.6.5", level=1)
    adrs_nuevos = [
