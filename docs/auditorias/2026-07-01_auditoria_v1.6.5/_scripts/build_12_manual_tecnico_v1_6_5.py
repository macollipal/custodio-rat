"""
Build 12 — Manual Técnico v1.6.5 (Post Iter 11 + Iter 12)
Genera: docs/documentacion_oficial/12_Manual_Tecnico_Custodio_RAT_Manager_v1.6.5.docx
Cambios v1.6.5:
...
OUT_FILE = os.path.join(OUT_DIR, "12_Manual_Tecnico_Custodio_RAT_Manager_v1.6.5.docx")
...
def build():
    ...
    add_cover(doc, title="MANUAL TÉCNICO",
              subtitle="Arquitectura, seguridad,部署 y operaciones",
              code=DOC_CODE)
    ...
    doc.add_heading("1. Cambios técnicos en v1.6.5", level=1)
    cambios_v18 = [
    ...
    doc.add_heading("2. Flujo de证据 ARCO con hash SHA-256", level=1)
