"""
Build 08 — API REST v1.6.5 (Post Iter 11 + Iter 12)
Genera: docs/documentacion_oficial/08_API_REST_Custodio_RAT_Manager_v1.6.5.docx
Cambios v1.6.5:
...
OUT_FILE = os.path.join(OUT_DIR, "08_API_REST_Custodio_RAT_Manager_v1.6.5.docx")
...
def build():
    ...
    doc.add_heading("2. Cambios en v1.6.5 — Endpoints relevantes", level=1)
    endpoints_v18 = [
    ...
    add_endpoint_table(doc, "2.1 Módulo TKT — Cambios v1.6.5", endpoints_v18)
