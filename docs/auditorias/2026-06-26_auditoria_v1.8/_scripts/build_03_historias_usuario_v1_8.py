"""
Build 03 — Historias de Usuario v1.8 (Post Iter 11 + Iter 12 audit-loop)
Genera: docs/documentacion_oficial/03_Historias_Usuario_Custodio_RAT_Manager_v1.8.docx
Cambios v1.8:
...
OUT_FILE = os.path.join(OUT_DIR, "03_Historias_Usuario_Custodio_RAT_Manager_v1.8.docx")
