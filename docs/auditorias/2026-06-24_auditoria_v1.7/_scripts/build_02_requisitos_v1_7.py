"""
Build 02 — Levantamiento de Requisitos v1.7 (Post Sprint 1 + Sprint 2 ARCO)
Genera: docs/documentacion_oficial/02_Requisitos_Custodio_RAT_Manager_v1.7.docx
Cambios v1.7:
- Sprint 1 (FORMADMIN ARCO QW1-QW10): RF-129 a RF-136
- Sprint 2 (SLA Alert + Export): RF-137 a RF-140
"""
import os
import sys
...
OUT_FILE = os.path.join(OUT_DIR, "02_Requisitos_Custodio_RAT_Manager_v1.7.docx")
...
def build():
    ...
    add_version_control(doc, DOC_CODE, DOC_TITLE, changes=[
        ...
        ("1.7", "Junio 2026", "_Sprint 1: FORMADMIN ARCO QW1-QW10 (RF-129 a RF-136). Sprint 2: SLA Alert T-2d (RF-137 a RF-138), Export ARCO CSV/Excel/PDF (RF-139 a RF-140)._"),
    ])
    add_toc(doc)
