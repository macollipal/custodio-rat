"""
Build 04 — Casos de Uso v1.7 (Sprint 1: FORMADMIN ARCO + Sprint 2: SLA Alert + Export ARCO)
Genera: docs/documentacion_oficial/04_Casos_de_Uso_Custodio_RAT_Manager_v1.7.docx
Cambios v1.7:
- Sprint 1: FORMADMIN ARCO (CU-059 a CU-063)
- Sprint 2: SLA Alert + Export ARCO (CU-064 a CU-068)
--- (v1.6 ---)
- CU-055: RatDetailModal con tabs Ver/Editar + PdfPreview
- CU-056: Drawer responsive 5-size (sm/md/lg/xl/full)
- CU-057: Dashboard clickable — Abrir RAT en modal
- CU-058: Sort estable (toSorted → spread+sort) + ARCO KPI compactas
--- (v1.5 ---)
- CU-051: CSRF protection con CSRFMiddleware
- CU-052: Encryption at Rest con Fernet
- CU-053: Service Layer
- CU-054: Schemas Pydantic
"""
import os
import sys
...
OUT_FILE = os.path.join(OUT_DIR, "04_Casos_de_Uso_Custodio_RAT_Manager_v1.7.docx")
...
def build():
    ...
    add_version_control(doc, DOC_CODE, DOC_TITLE, changes=[
        ...
        ("1.7", "Junio 2026", "_Sprint 1: FORMADMIN ARCO (CU-059 a CU-063). Sprint 2: SLA Alert + Export ARCO (CU-064 a CU-068)._"),
    ])
    add_toc(doc)
    ...
    casos = [
        ...
        ["_CU-059_", "_FormADMIN Validar RUT en vivo_", "AC-02/03", "RF-120", "_POST /formadmin/validate-rut_"],
        ["_CU-060_", "_FormADMIN Confirmar email doble input_", "AC-02/03", "RF-121", "_POST /formadmin/confirm-email_"],
        ["_CU-061_", "_FormADMIN Tooltip Tipo ARCO_", "AC-02/03", "RF-122", "_UI: tooltip informativo ARCO_"],
        ["_CU-062_", "_FormADMIN Detectar titular duplicado_", "AC-02/03", "RF-123", "_POST /formadmin/check-duplicate_"],
        ["_CU-063_", "_FormADMIN Selector RAT con búsqueda_", "AC-02/03", "RF-124", "_UI: selector RAT searchable_"],
        ...
        ["_CU-055_", "_RatDetailModal con tabs Ver/Editar + PdfPreview_", "AC-02/03", "RF-125", "_UI modal con tabs + preview PDF_"],
        ["_CU-056_", "_Drawer responsive 5-size (sm/md/lg/xl/full)_", "AC-02/03", "RF-126", "_UI drawer adaptativo_"],
        ["_CU-057_", "_Dashboard clickable — Abrir RAT en modal_", "AC-01/02/03", "RF-127", "_UI: dashboard con drill-down_"],
        ["_CU-058_", "_Sort estable (toSorted → spread+sort) + ARCO KPI compactas_", "AC-01/02/03", "RF-128", "_UI: sort estable + KPIs_"],
        ["_CU-064_", "_Encolar alerta SLA T-2 días_", "Sistema", "RF-129", "_Background job: SLA alert T-2_"],
        ["_CU-065_", "_Exportar tickets ARCO a CSV_", "AC-01/02", "RF-130", "_GET /tickets-arco/export/csv_"],
        ["_CU-066_", "_Exportar tickets ARCO a Excel_", "AC-01/02", "RF-131", "_GET /tickets-arco/export/xlsx_"],
        ["_CU-067_", "_Exportar tickets ARCO a PDF_", "AC-01/02", "RF-132", "_GET /tickets-arco/export/pdf_"],
        ["_CU-068_", "_UI Dropdown Exportar tickets ARCO_", "AC-01/02", "RF-133", "_UI: dropdown export multi-format_"],
    ]
