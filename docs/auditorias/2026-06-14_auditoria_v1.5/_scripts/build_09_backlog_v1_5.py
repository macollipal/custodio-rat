"""
Build 09 — Backlog de Producto v1.5 (Post S14 + C1 + A6 + A10)
Genera: docs/documentacion_oficial/09_Backlog_Producto_Custodio_RAT_Manager_v1.5.docx
Cambios v1.5:
...
OUT_FILE = os.path.join(OUT_DIR, "09_Backlog_Producto_Custodio_RAT_Manager_v1.5.docx")
