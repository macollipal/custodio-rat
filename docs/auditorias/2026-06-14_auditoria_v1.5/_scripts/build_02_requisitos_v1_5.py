"""
Build 02 — Levantamiento de Requisitos v1.5 (Post S14 + C1 + A6 + A10)
Genera: docs/documentacion_oficial/02_Requisitos_Custodio_RAT_Manager_v1.5.docx
Cambios v1.5:
- RF-120: CSRF Protection con middleware y cookies samesite=lax
- RF-121: Encryption at Rest con Fernet para BYTEA (RAT + EncargadoContrato)
- RF-122: Service Layer para centralizar lógica de negocio
- RF-123: Schemas Pydantic con response_model en 35+ endpoints
"""
import os
import sys
...
_theme_custodio.DOC_VERSION = "v1.5"

OUT_DIR = r"C:\Users\chelo\Desktop\RAT_opencode\docs\documentacion_oficial"
OUT_FILE = os.path.join(OUT_DIR, "02_Requisitos_Custodio_RAT_Manager_v1.5.docx")
