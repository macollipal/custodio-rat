"""
Build 04 — Casos de Uso v1.5 (Post S14 + C1 + A6 + A10)
Genera: docs/documentacion_oficial/04_Casos_de_Uso_Custodio_RAT_Manager_v1.5.docx
Cambios v1.5:
...
OUT_FILE = os.path.join(OUT_DIR, "04_Casos_de_Uso_Custodio_RAT_Manager_v1.5.docx")
