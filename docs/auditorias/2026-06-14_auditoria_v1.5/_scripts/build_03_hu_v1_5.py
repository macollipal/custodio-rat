"""
Build 03 — Historias de Usuario v1.5 (Post S14 + C1 + A6 + A10)
Genera: docs/documentacion_oficial/03_Historias_Usuario_Custodio_RAT_Manager_v1.5.docx
Cambios v1.5:
- HU-064: CSRF protection con samesite=lax
- HU-065: Encryption at Rest con Fernet
- HU-066: Service Layer
- HU-067: Schemas Pydantic
"""
import os
import sys
...
OUT_FILE = os.path.join(OUT_DIR, "03_Historias_Usuario_Custodio_RAT_Manager_v1.5.docx")
