"""
Build 12 — Manual Técnico v1.5 (Post S14 + C1 + A6 + A10)
Genera: docs/documentacion_oficial/12_Manual_Tecnico_Custodio_RAT_Manager_v1.5.docx
Cambios v1.5:
...
OUT_FILE = os.path.join(OUT_DIR, "12_Manual_Tecnico_Custodio_RAT_Manager_v1.5.docx")
