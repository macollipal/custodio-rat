"""
Build Matriz — Matriz de Trazabilidad v1.6-BETA (Post UI/UX + Fix seguridad)
Genera: docs/documentacion_oficial/Matriz_Trazabilidad_Custodio_RAT_Manager_v1.6.docx
Cambios v1.6-BETA:
- TC-015: RatDetailModal tabs, TC-016: PdfPreview, TC-017: Sort estable, TC-018: Dashboard clickable, TC-019: IDOR fix
--- (v1.5 ---)
- CSRF Protection (TC-SEC-01)
- Encryption at Rest (TC-SEC-02)
- Service Layer (TC-ARC-01)
- Schemas Pydantic (TC-API-01)
"""
import os
import sys
...
_theme_custodio.DOC_VERSION = "v1.6"

OUT_DIR = r"C:\Users\chelo\Desktop\RAT_opencode\docs\documentacion_oficial"
ASSETS_DIR = os.path.join(OUT_DIR, "assets")
OUT_FILE = os.path.join(OUT_DIR, "Matriz_Trazabilidad_Custodio_RAT_Manager_v1.6.docx")
