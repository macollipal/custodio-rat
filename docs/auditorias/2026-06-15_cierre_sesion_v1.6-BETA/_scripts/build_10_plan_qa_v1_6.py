"""
Build 10 — Plan de QA v1.6-BETA (Post UI/UX + Fix seguridad)
Genera: docs/documentacion_oficial/10_Plan_QA_Custodio_RAT_Manager_v1.6.docx
Cambios v1.6-BETA:
- TC-015: RatDetailModal tabs Ver/Editar
- TC-016: PdfPreview archivo base legal
- TC-017: Sort estable (spread+sort vs toSorted)
- TC-018: Dashboard clickable — modal in-page
- TC-019: IDOR /archivo endpoint
--- (v1.5 ---)
- Nuevos casos: CSRF middleware, Encryption migration, Service Layer
"""
import os
import sys
...
OUT_FILE = os.path.join(OUT_DIR, "10_Plan_QA_Custodio_RAT_Manager_v1.6.docx")
