"""
Build 03 — Historias de Usuario v1.6-BETA (Post UI/UX + Fix seguridad)
Genera: docs/documentacion_oficial/03_Historias_Usuario_Custodio_RAT_Manager_v1.6.docx
Cambios v1.6-BETA:
- HU-068: RatDetailModal con tabs Ver/Editar
- HU-069: Drawer responsive 5-size
- HU-070: Dashboard clickable recientes
- HU-071: Sort estable + ARCO KPI compactas
"""
import os
import sys
...
OUT_FILE = os.path.join(OUT_DIR, "03_Historias_Usuario_Custodio_RAT_Manager_v1.6.docx")
