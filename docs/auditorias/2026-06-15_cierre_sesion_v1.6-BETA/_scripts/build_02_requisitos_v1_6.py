"""
Build 02 — Levantamiento de Requisitos v1.6-BETA (Post UI/UX + Fix seguridad)
Genera: docs/documentacion_oficial/02_Requisitos_Custodio_RAT_Manager_v1.6.docx
Cambios v1.6-BETA:
- RF-124: RatDetailModal con tabs Ver/Editar + PdfPreview
- RF-125: Drawer responsive (5 sizes, sm/md/lg/xl/full)
- RF-126: Dashboard clickable — Abrir RAT en modal in-page
- RF-127: Sort estable (toSorted → spread+sort) + ARCO KPI 6-col
- RF-128: Fix IDOR+500 en /rats/{id}/archivo
"""
import os
import sys
...
OUT_FILE = os.path.join(OUT_DIR, "02_Requisitos_Custodio_RAT_Manager_v1.6.docx")
