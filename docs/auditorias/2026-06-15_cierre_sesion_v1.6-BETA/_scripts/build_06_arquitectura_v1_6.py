"""
Build 06 — Arquitectura de Software v1.6-BETA (Post UI/UX + Fix seguridad)
Genera: docs/documentacion_oficial/06_Arquitectura_Software_Custodio_RAT_Manager_v1.6.docx
Cambios v1.6-BETA:
...
--- (v1.5 ---)
- Crypto Layer documentado (Fernet encryption)
- Service Layer documentado (5 servicios)
- CSRFMiddleware documentado
- ADR: Encryption Strategy
"""
import os
import sys
...
OUT_FILE = os.path.join(OUT_DIR, "06_Arquitectura_Software_Custodio_RAT_Manager_v1.6.docx")
