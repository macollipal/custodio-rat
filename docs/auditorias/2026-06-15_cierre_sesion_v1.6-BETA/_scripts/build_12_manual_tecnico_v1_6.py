"""
Build 12 — Manual Técnico v1.6-BETA (Post UI/UX + Fix seguridad)
Genera: docs/documentacion_oficial/12_Manual_Tecnico_Custodio_RAT_Manager_v1.6.docx
Cambios v1.6-BETA:
...
OUT_FILE = os.path.join(OUT_DIR, "12_Manual_Tecnico_Custodio_RAT_Manager_v1.6.docx")
