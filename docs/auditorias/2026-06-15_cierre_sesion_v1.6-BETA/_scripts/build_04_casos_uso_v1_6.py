"""
Build 04 — Casos de Uso v1.6-BETA (Post UI/UX + Fix seguridad)
Genera: docs/documentacion_oficial/04_Casos_de_Uso_Custodio_RAT_Manager_v1.6.docx
Cambios v1.6-BETA:
...
OUT_FILE = os.path.join(OUT_DIR, "04_Casos_de_Uso_Custodio_RAT_Manager_v1.6.docx")
