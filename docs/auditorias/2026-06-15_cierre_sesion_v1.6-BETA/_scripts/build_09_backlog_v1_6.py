"""
Build 09 — Backlog de Producto v1.6-BETA (Post UI/UX + Fix seguridad)
Genera: docs/documentacion_oficial/09_Backlog_Producto_Custodio_RAT_Manager_v1.6.docx
Cambios v1.6-BETA:
- RatDetailModal con tabs (DT-UX-01)
- Drawer responsive 5-size (DT-UX-02)
- Dashboard clickable (DT-UX-03)
- Sort estable + IDOR fix (DT-UX-04)
--- (v1.5 ---)
- CSRF Protection (DT-SEC-01)
- Encryption at Rest (DT-SEC-02)
- Service Layer (DT-ARC-01)
"""
import os
import sys
...
OUT_FILE = os.path.join(OUT_DIR, "09_Backlog_Producto_Custodio_RAT_Manager_v1.6.docx")
...
def build():
    ...
    add_open_questions(doc, [
        "¿Se prioriza CSRF (S14) para v1.4 o v1.6?",
