"""
Build 08 — API REST v1.10 (Post Iter 11 + Iter 12)
Genera: docs/documentacion_oficial/08_API_REST_Custodio_RAT_Manager_v1.10.docx
Cambios v1.10:
...
OUT_FILE = os.path.join(OUT_DIR, "08_API_REST_Custodio_RAT_Manager_v1.10.docx")
...
def build():
    ...
    doc.add_heading("2. Cambios en v1.10 — Endpoints relevantes", level=1)
    endpoints_v18 = [
    ...
    add_endpoint_table(doc, "2.1 Módulo TKT — Cambios v1.10", endpoints_v18)

    doc.add_heading("3. Cambios en v1.10 — IDOR multi-tenant y homologación", level=1)
    endpoints_v19 = [
    ...
    add_endpoint_table(doc, "3.1 Módulo RAT — IDOR multi-tenant v1.10", endpoints_v19)
