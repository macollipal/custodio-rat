"""
Build MTX — Matriz de Trazabilidad v1.10 (Post Iter 11 + Iter 12)
Genera: docs/documentacion_oficial/Matriz_Trazabilidad_Custodio_RAT_Manager_v1.10.docx
Cambios v1.10:
...
OUT_FILE = os.path.join(OUT_DIR, "Matriz_Trazabilidad_Custodio_RAT_Manager_v1.10.docx")
...
def build():
    ...
    doc.add_heading("1. Matriz RF → HU → CU → TC (v1.10 — Iter 13)", level=1)
