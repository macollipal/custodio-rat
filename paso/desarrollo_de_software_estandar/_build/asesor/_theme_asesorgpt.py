"""
Custodio Asesor — Tema visual para los .docx del módulo RAG
============================================================

Fork de _theme_custodio.py con:
  - Paleta verde-dorado (AD-ASES-16)
  - Marca: Custodio Asesor (RAG de Custodio RAT Manager)
  - Detección de subrayados con guiones bajos: _texto_ → r.underline = True
  - Prefijos de identificadores: RF-ASES, US-ASES, CU-ASES, TC-ASES, DT-ASES, AD-ASES

Hereda 1:1 toda la maquinaria de build (portada, header/footer, TOC, tablas,
bloques nota/adv/riesgo, Mermaid→PNG, helpers de listas, apéndices A/B/C).
"""
...
# =============================================================================
# CONSTANTES DE MARCA — Custodio Asesor
# =============================================================================

BRAND_NAME = "CUSTODIO ASESOR"
BRAND_FULL = "Custodio Asesor (RAG)"
BRAND_TAGLINE = (
    "Asistente IA especializado en la Ley N.° 21.719 de Chile — "
...
# Paleta verde-dorado (AD-ASES-16)
COLOR_PRIMARY = RGBColor(0x1B, 0x5E, 0x20)        # verde institucional oscuro
COLOR_SECONDARY = RGBColor(0x2E, 0x7D, 0x32)      # verde medio
COLOR_TEXT = RGBColor(0x40, 0x40, 0x40)           # gris oscuro para H3
COLOR_BODY = RGBColor(0x00, 0x00, 0x00)           # negro para cuerpo
COLOR_MUTED = RGBColor(0x80, 0x80, 0x80)          # gris medio
COLOR_HEADER_BG = "D9EAD3"                        # verde muy claro (cabecera tabla)
COLOR_NOTA_BG = "EDF7E5"                          # verde palidísimo
COLOR_ADV_BG = "FFF8E5"                           # amarillo suave (advertencia)
COLOR_RIESGO_BG = "FBEAEA"                        # rojo suave
COLOR_BORDER_NOTA = "2E7D32"                      # verde
COLOR_BORDER_ADV = "BF8F00"                       # dorado
COLOR_BORDER_RIESGO = "C00000"                    # rojo
...
def new_document() -> _Doc:
    """Crea un documento con los estilos por defecto del tema Custodio Asesor."""
    doc = Document()
...
def add_header_footer(doc: _Doc, doc_title: str) -> None:
    ...
    for section in doc.sections:
        ...
        r0a = p0.add_run("▣  CUSTODIO ASESOR  ")
        r0a.bold = True
        r0a.font.size = Pt(9)
        ...
        _add_bottom_border(p0, color="1B5E20", size_pt=0.75)
...
def _add_bottom_border(paragraph, color="1B5E20", size_pt=0.75) -> None:
...
def add_cover(doc: _Doc, title: str, subtitle: str, code: str) -> None:
    ...
    _add_paragraph_border_box(band_top, color="1B5E20", size_pt=2.0,
                              background="1B5E20")
    ...
    _add_bottom_border(p_sep, color="BF8F00", size_pt=1.5)
    r_sep = p_sep.add_run("  ")
    ...
    _add_paragraph_border_box(p_foot, color="1B5E20", size_pt=2.0,
                              background="1B5E20")
...
def _add_paragraph_border_box(paragraph, color="1B5E20", size_pt=1.0,
...
def _set_cell_shading(cell, color) -> None:
    ...
    # rgb='1B5E20' -> ya viene en hex sin #. Asegurar 6 chars.
    if len(hex_str) > 6:
        hex_str = hex_str[-6:]
...
def add_styled_table(doc: _Doc, headers: list[str], rows: list[list[str]],
    ...
    Convención del módulo Asesor: los IDs nuevos en versiones >=1.1 se subrayan."""
